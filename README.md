...
- **프로젝트 개요**: 신규 고객의 97%가 친구 요청 외 활동 없이 이탈하여 초기 온보딩 단계에 초점을 맞춰, 커뮤니티·유저군 중심의 고객 관리와 앱 개선 전략을 도출하는 것을 목표로 한다. 특히, 5월 한 달간 약 60만 명이 신규 유입되는 폭발적 성장을 기록했으나, 대다수 유저가 핵심 네트워크에 편입되지 못해 장기 활동으로 이어지지 않았다.
